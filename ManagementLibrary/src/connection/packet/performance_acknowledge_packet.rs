...
pub struct PerformanceAcknowledgePacket {
    length: Vec<u8>,
    id: Vec<u8>,
    data: Vec<u8>,
...
impl PerformanceAcknowledgePacket {
    pub fn new() -> Self {
        Self {
            length: length_to_byte(16),
            id: PacketType::PerformanceAcknowledgePacket.as_byte(),
            data: Vec::new(),
            packet_type: PacketType::PerformanceAcknowledgePacket,
        }
    }
}

impl Packet for PerformanceAcknowledgePacket {
